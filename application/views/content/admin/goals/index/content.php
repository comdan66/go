      ...
      if ($goals) {
        foreach ($goals as $i => $goal) { ?>
          <tr>
            ...
            <td class='map'><?php echo img ($goal->picture ('60x60', 11, 'mid'), false, "data-id='" . $goal->id . "' class='fancybox_goal'");?></td>
            <td class='map'><?php echo $goal->view ? img ($goal->view->picture ('60x60', 70), false, "data-id='" . $goal->id . "' class='fancybox_view'") : anchor (base_url ('admin', 'goals', 'view', $goal->id), '未設定');?></td>
            <td class='edit'>
