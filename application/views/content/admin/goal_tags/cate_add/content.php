...
<?php
    ...
    <form action='<?php echo base_url (array ('admin', 'goal_tags', 'cate_create'));?>' method='post' enctype='multipart/form-data'>
      <table class='table-form'>
        <tbody>
          ...
          <tr>
            <th>標簽</th>
            <td>
        <?php foreach (GoalTag::all (array ('conditions' => array ('goal_tag_category_id = ?', 0))) as $tag) { ?>
                <div class='tag'>
